...
from twod_mlm_utils import multi_head_attention_forward
...
@register_model_architecture("rna_twod_mlm", "rna_twod_mlm_big")
...
@register_model_architecture("rna_twod_mlm", "rna_twod_mlm_large")
...
@register_model_architecture("rna_twod_mlm", "rna_twod_mlm_xl")
...
@register_model_architecture("rna_twod_mlm", "rna_twod_mlm_1b")
...
@register_model_architecture('rna_twod_mlm', 'rna_twod_mlm_xbase')
