...
@register_model('rna_twod_pmlm')
class RNAPairwiseTwoDModel(BaseFairseqModel):
...
class RNAMaskedLMEncoder(MaskedLMEncoder):
    ...
    def pairwise_feature(self, x, masked_tokens):
        ...
        x_ret = self.p_layer_norm(self.p_activation_fn(self.plm_head_transform_weight(x_pair)))# (B, T, T, n**2)
...
@register_model_architecture('rna_twod_pmlm', 'rna_twod_pmlm_base')
...
@register_model_architecture('rna_twod_pmlm', 'rna_twod_pmlm_small')
...
@register_model_architecture('rna_twod_pmlm', 'rna_twod_pmlm')
def prot_architecture(args):
    base_architecture(args)

@register_model_architecture("rna_twod_pmlm", "rna_twod_pmlm_big")
...
@register_model_architecture("rna_twod_pmlm", "rna_twod_pmlm_large")
...
@register_model_architecture("rna_twod_pmlm", "rna_twod_pmlm_xl")
...
@register_model_architecture("rna_twod_pmlm", "rna_twod_pmlm_1b")
...
@register_model_architecture('rna_twod_pmlm', 'rna_twod_pmlm_xbase')
...
@register_model_architecture("rna_twod_pmlm", "rna_twod_pmlm_finetune")
