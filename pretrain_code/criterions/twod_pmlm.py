...
@register_criterion('rna_twod_pmlm')
class RNAPairwiseTwoDMaskedLMCriterion(FairseqCriterion):
    """
    ...
    def forward(self, model, sample, reduce=True):
        ...
        logits, ni, extra = model(**sample['net_input'], is_twod=True, masked_tokens=masked_tokens, 
